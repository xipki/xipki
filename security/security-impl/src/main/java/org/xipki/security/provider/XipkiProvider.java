...
public class XipkiProvider extends Provider
{
    ...
    private static class MyPrivilegedAction implements PrivilegedAction
    {
        ...
        public Object run()
        {
            ...
            provider.put("Signature.NONEwithPlain-ECDSA", PlainECDSASignatureSpi.NONE.class.getName());
            ...
            provider.put("Signature.SHA1withPlain-ECDSA", PlainECDSASignatureSpi.SHA1.class.getName());
            ...
            provider.put("Signature.SHA224withPlain-ECDSA", PlainECDSASignatureSpi.SHA224.class.getName());
            ...
            provider.put("Signature.SHA256withPlain-ECDSA", PlainECDSASignatureSpi.SHA256.class.getName());
            ...
            provider.put("Signature.SHA384withPlain-ECDSA", PlainECDSASignatureSpi.SHA384.class.getName());
            ...
            provider.put("Signature.SHA512withPlain-ECDSA", PlainECDSASignatureSpi.SHA512.class.getName());
            ...
            provider.put("Signature.RIPEMD160withPlain-ECDSA", PlainECDSASignatureSpi.RIPEMD160.class.getName());
            provider.put("Alg.Alias.Signature.Plain-ECDSAwithRIPEMD160", "RIPEMD160withPlain-ECDSA");
            provider.put("Alg.Alias.Signature.RIPEMD160withPlainECDSA",  "RIPEMD160withPlain-ECDSA");
            provider.put("Alg.Alias.Signature.PlainECDSAwithRIPEMD160",  "RIPEMD160withPlain-ECDSA");
