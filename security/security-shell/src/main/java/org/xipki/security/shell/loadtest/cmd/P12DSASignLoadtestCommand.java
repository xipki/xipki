...
import org.xipki.security.shell.loadtest.p12.P12DSASignLoadTest;

/**
 * @author Lijun Liao
 */

@Command(scope = "xipki-tk", name = "speed-dsa-sign-p12", description="performance test of PKCS#12 DSA signature creation")
public class P12DSASignLoadtestCommand extends P12SignLoadtestCommand
{
    @Option(name = "--plen",
