...
import org.xipki.security.shell.loadtest.p11.P11ECSignLoadTest;

/**
 * @author Lijun Liao
 */

@Command(scope = "xipki-tk", name = "speed-ec-sign", description="performance test of PKCS#11 EC signature creation")
public class P11ECSignLoadtestCommand extends P11SignLoadtestCommand
{
    @Option(name = "--curve",
            required = true,
