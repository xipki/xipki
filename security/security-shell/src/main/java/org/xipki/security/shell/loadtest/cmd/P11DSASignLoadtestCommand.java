...
import org.xipki.security.shell.loadtest.p11.P11DSASignLoadTest;

/**
 * @author Lijun Liao
 */

@Command(scope = "xipki-tk", name = "speed-dsa-sign", description="performance test of PKCS#11 DSA signature creation")
public class P11DSASignLoadtestCommand extends P11SignLoadtestCommand
{
    @Option(name = "--plen",
