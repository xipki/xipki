...
import org.xipki.security.shell.loadtest.p12.P12RSASignLoadTest;

/**
 * @author Lijun Liao
 */

@Command(scope = "xipki-tk", name = "speed-rsa-sign-p12", description="performance test of PKCS#12 RSA signature creation")
public class P12RSASignLoadtestCommand extends P12SignLoadtestCommand
{
