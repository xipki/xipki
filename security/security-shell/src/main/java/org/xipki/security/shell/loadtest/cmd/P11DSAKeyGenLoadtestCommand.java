...
import org.xipki.security.shell.loadtest.p11.P11DSAKeyGenLoadTest;

/**
 * @author Lijun Liao
 */

@Command(scope = "xipki-tk", name = "speed-dsa-gen", description="performance test of PKCS#11 DSA key generation")
public class P11DSAKeyGenLoadtestCommand extends P11LoadtestCommand
{
    @Option(name = "--plen",
