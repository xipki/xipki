...
import org.xipki.security.shell.loadtest.p12.P12RSAKeyGenLoadTest;

/**
 * @author Lijun Liao
 */

@Command(scope = "xipki-tk", name = "speed-rsa-gen-p12", description="performance test of PKCS#12 RSA key generation")
public class P12RSAKeyGenLoadtestCommand extends SecurityLoadtestCommand
{
