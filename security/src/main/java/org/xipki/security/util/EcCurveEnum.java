...
public enum EcCurveEnum {
  ...
  // EC
  P256(OIDs.Curve.secp256r1, 256, "P256", "SECP256R1"),
  P384(OIDs.Curve.secp384r1, 384, "P384", "SECP384R1"),
  P521(OIDs.Curve.secp521r1, 521, "P521", "SECP521R1"),
  /**
  ...
  SM2(OIDs.Curve.sm2p256v1, 256, "SM2P256V1", "SM2"),
  FRP256V1( OIDs.Curve.frp256v1,  256, "FRP256V1"),
  ED25519(false, OIDs.Curve.id_ED25519, 256, "ED25519", "EDWARDS25519"),
  ED448(false,   OIDs.Curve.id_ED448,   448, "ED448", "EDWARDS448"),
  X25519(false,  OIDs.Curve.id_X25519,  256, "X25519", "CURVE25519"),
  X448(false,    OIDs.Curve.id_X448,    448, "X448", "CURVE448");
  ...
  EcCurveEnum(boolean weierstrauss, ASN1ObjectIdentifier oid, int fieldBitSize, String... aliases) {
    this.oid = oid;
    ...
    this.algId = weierstrauss ? new AlgorithmIdentifier(OIDs.Algo.id_ecPublicKey, oid)
  ...
  public static EcCurveEnum ofAlias(String alias) {
    alias = alias.toUpperCase(Locale.US).replace("-", "").replace("_", "");
    for (EcCurveEnum m : EcCurveEnum.values()) {
  ...
  public static EcCurveEnum ofEncodedOid(byte[] encodedOid) {
    ...
    throw new IllegalArgumentException("found no EcCurveEnum for OID " + Hex.encode(encodedOid));
  }
