...
public final class DSAParameterCache {
  ...
  static {
    /*
     The following DSA parameters are generated using the following code
     ...
     and with JRE: openjdk version "1.8.0_252"
      ...
      OpenJDK 64-Bit Server VM (build 25.252-b09, mixed mode)
       ...
       DSAParameterGenerationParameters genParams =
           new DSAParameterGenerationParameters(plen, qlen, certainty, rnd);
       gen.init(genParams);
     ...
     hexadecimal representation) have been used as initial seed s:
      ...
      Seed_p1024_q160 for plen=1024 and qlen=160:
      3243F6A8885A308D313198A2E03707344A409382

      Seed_p2048_q224 for plen=2048 and qlen=224:
      2299F31D0082EFA98EC4E6C89452821E638D0137

      Seed_p2048_q256 for plen=2048 and qlen=256:
      7BE5466CF34E90C6CC0AC29B7C97C50DD3F84D5B

      Seed_p3072_q256 for plen=3072 and qlen=256:
    ...
    String Q = "DCF35E20A2FBD43A22BE859971410E65387D566B";
    ...
    addDSAParamSpec(1024, 160, P, Q, G);
    ...
    Q = "F24D2D70B79B39FDB1387D85833F472997CA3C2683DD51E5CE07371B";
    ...
    addDSAParamSpec(2048, 224, P, Q, G);
    ...
    Q = "86355AFD92DE59DE8AFCCF8A6C8AE873CE0A08B35F842CAF93ECBF38DB4F5CE9";
    ...
    addDSAParamSpec(2048, 256, P, Q, G);
    ...
    Q = "980C693C7201AD7D5E93016DF531253845E7E28CDE4B371A9C342EEB7D71E165";
    ...
    addDSAParamSpec(3072, 256, P, Q, G);
  }

  private DSAParameterCache() {
  }

  private static void addDSAParamSpec(int plen, int qlen, String hexP,  String hexQ, String hexG) {
    ...
    if (plen > g.bitLength() + 4) {
      match = false;
      LOG.error("plen and G do not match");
    }
