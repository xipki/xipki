 ...
 */
public enum CompositeSigAlgoSuite {
  ...
  CompositeSigAlgoSuite(ASN1ObjectIdentifier oid, String label, HashAlgo ph,
  ...
  public static CompositeSigAlgoSuite ofOid(ASN1ObjectIdentifier oid) {
    for (CompositeSigAlgoSuite as : CompositeSigAlgoSuite.values()) {
