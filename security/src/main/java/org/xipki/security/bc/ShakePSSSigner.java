// #THIRDPARTY# Based on PSSSigner from BoucyCastle.
...
public class ShakePSSSigner
    ...
    private final XiShakeDigest         digest;
        ...
        throws CryptoException, DataLengthException
    {
        ...
        byte[] dbMask = digest.maskGeneratorFunction(h, 0, h.length, block.length - hLen - 1);
        ...
        byte[]      signature)
    {
        ...
        byte[] dbMask = digest.maskGeneratorFunction(block, block.length - hLen - 1, hLen,
                        block.length - hLen - 1);
