...
public enum CompositeSigSuite {
  ...
  MLDSA44_RSA2048_PSS_SHA256(
      ...
      CompSigMldsaVariant.mldsa44, CompSigTradVariant.RSA2048_PSS),
  ...
  MLDSA65_RSA4096_PSS_SHA512(
      ...
      CompSigMldsaVariant.mldsa65, CompSigTradVariant.RSA4096_PSS),
  ...
  private final CompSigMldsaVariant pqcVariant;

  private final CompSigTradVariant tradVariant;

  private final KeySpec keySpec;

  private final byte[] label;

  CompositeSigSuite(ASN1ObjectIdentifier oid, String label, HashAlgo ph,
                    CompSigMldsaVariant pqcVariant, CompSigTradVariant tradVariant) {
  ...
  public CompSigMldsaVariant pqcVariant() {
    return pqcVariant;
  }

  public CompSigTradVariant tradVariant() {
    return tradVariant;
  }
  ...
  public static CompositeSigSuite ofVariants(
      CompSigMldsaVariant pqcVariant, CompSigTradVariant tradVariant) {
    for (CompositeSigSuite as : CompositeSigSuite.values()) {
  ...
  public static CompositeSigSuite ofKeySpecs(KeySpec pqcKeySpec, KeySpec tradKeySpec) {
    for (CompositeSigSuite as : CompositeSigSuite.values()) {
  ...
  public static CompositeSigSuite getAlgoSuite(ASN1ObjectIdentifier oid) {
    for (CompositeSigSuite as : CompositeSigSuite.values()) {
      if (as.oid.equals(oid)) {
        return as;
      }
  ...
  public static CompositeSigSuite getAlgoSuite(AlgorithmIdentifier algId) {
