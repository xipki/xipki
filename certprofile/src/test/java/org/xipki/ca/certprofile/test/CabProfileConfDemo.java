...
public class CabProfileConfDemo extends ProfileConfBuilder {
  ...
  public static void main(String[] args) {
    try {
      // CA/Browser Forum
      certprofileCabRootCa(qa_cab_dir + "/certprofile-cab-rootca.json");
      certprofileCabSubCa (qa_cab_dir + "/certprofile-cab-subca.json");
      certprofileCabDomainValidatedTls(qa_cab_dir + "/certprofile-cab-domain-validated.json");
      certprofileCabOrganizationValidatedTls(qa_cab_dir + "/certprofile-cab-org-validated.json");
