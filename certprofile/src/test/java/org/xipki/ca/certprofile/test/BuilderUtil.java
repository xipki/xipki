...
public class BuilderUtil {
    ...
    if (keypairGenMode == null || keypairGenMode == KeypairGenMode.FORBIDDEM) {
      ...
      switch (allowedKeyMode) {
        ...
        case COMPKEM:
          ...
          break;
        default:
          throw new IllegalStateException("unknown AllowedKeyMode " + allowedKeyMode);
      }
  ...
  public static List<KeySpec> createKeyAlgorithmTypes(AllowKeyMode... allowKeyModes) {
  ...
  private static List<KeySpec> createKeyAlgorithmTypes0(AllowKeyMode keyMode) {
    ...
    switch (keyMode) {
      ...
      case EC:
        ...
        break;
      case EC_SECP:
        list.add(KeySpec.P256);
        list.add(KeySpec.P384);
        list.add(KeySpec.P521);
        break;
      case X25519:
