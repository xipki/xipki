...
public class DescribableOid extends V1Describable {
  ...
  public static DescribableOid parse(JsonMap json) throws CodecException {
    return new DescribableOid(json.getString("description"), json.getNnString("oid"));
  }

  public static DescribableOid parseNn(JsonMap json, String key) throws CodecException {
