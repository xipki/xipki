...
public class DescribableInt extends V1Describable {
  ...
  public static DescribableInt parse(JsonMap json) throws CodecException {
    return new DescribableInt(json.getString("description"), json.getNnInt("value"));
  }

  public static DescribableInt parseNn(JsonMap json, String key) throws CodecException {
  ...
  public static DescribableInt parse(JsonMap json, String key) throws CodecException {
    JsonMap map = json.getMap(key);
    return (map == null) ? null : parse(map);
  }

  public static List<DescribableInt> parseList(JsonList json) throws CodecException {
