...
public class V1AlgorithmType {
  ...
  public V1AlgorithmType(List<DescribableOid> algorithms, V1KeyParametersType parameters) {
  ...
  public static V1AlgorithmType parse(JsonMap json) throws CodecException {
    List<DescribableOid> algorithms = DescribableOid.parseList(json.getNnList("algorithms"));
    JsonMap map = json.getMap("parameters");
    V1KeyParametersType parameters = (map == null) ? null : V1KeyParametersType.parse(map);
