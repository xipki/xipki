...
public class DescribableBinary extends V1Describable {
  ...
  public static DescribableBinary parse(JsonMap json) throws CodecException {
    return new DescribableBinary(json.getString("description"), json.getNnBytes("value"));
  }

  public static DescribableBinary parseNn(JsonMap json, String key) throws CodecException {
  ...
  public static DescribableBinary parse(JsonMap json, String key) throws CodecException {
