...
public class V1ConstantExtnValue {
  ...
  public ConstantExtnValue toV2() {
    ConstantExtnValue.Type v2t =
        (type == null || TYPE_ASN1.equalsIgnoreCase(type)) ? ConstantExtnValue.Type.ASN1
        : TYPE_INTEGER.equalsIgnoreCase(type) ? ConstantExtnValue.Type.INTEGER
        : TYPE_BIT_STRING.equalsIgnoreCase(type) ? ConstantExtnValue.Type.BITSTRING
        : TYPE_OCTET_STRING.equalsIgnoreCase(type) ? ConstantExtnValue.Type.OCTETSTRING
        : TYPE_PRINTABLE_STRING.equalsIgnoreCase(type) ? ConstantExtnValue.Type.PRINTABLE
        : TYPE_UTF8_STRING.equalsIgnoreCase(type) ? ConstantExtnValue.Type.UTF8
        : null;
    if (v2t == null) {
      throw new IllegalArgumentException("unknown ConstantExtValue.type '" + type + "'");
    }
  ...
  public static V1ConstantExtnValue parse(JsonMap json) throws CodecException {
    return new V1ConstantExtnValue(json.getString("type"), json.getString("value"));
  }
