...
import org.xipki.ca.certprofile.xijson.conf.ExtensionValueConf.BiometricInfo;
...
public class V1BiometricInfo {
  ...
  private V1BiometricInfo(List<BiometricType> types, List<DescribableOid> hashAlgorithms,
  ...
  public static V1BiometricInfo parse(JsonMap json) throws CodecException {
    ...
    TripleState includeSourceDataUri = json.getNnEnum("includeSourceDataUri", TripleState.class);
  ...
  private static class BiometricType {
    ...
    public static BiometricType parse(JsonMap json) throws CodecException {
      ...
      return (predefined != null) ? new BiometricType(predefined) : new BiometricType(oid);
    }
