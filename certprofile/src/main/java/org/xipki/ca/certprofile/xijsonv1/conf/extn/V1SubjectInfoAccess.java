...
import org.xipki.ca.certprofile.xijson.conf.ExtensionValueConf.SubjectInfoAccess;
...
public class V1SubjectInfoAccess {
  ...
  public SubjectInfoAccess toV2() {
    List<ExtensionValueConf.Access> list = new ArrayList<>(accesses.size());
