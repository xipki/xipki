...
/**
 * V1 General Subtree Type type definition.
 *
...
public class V1GeneralSubtreeType {
  ...
  public static V1GeneralSubtreeType parse(JsonMap json) throws CodecException {
    Base base = Base.parse(json.getNnMap("base"));
    return new V1GeneralSubtreeType(base);
  }

  public static List<V1GeneralSubtreeType> parseList(JsonList json) throws CodecException {
