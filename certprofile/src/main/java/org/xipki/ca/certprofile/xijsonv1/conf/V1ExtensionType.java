...
import org.xipki.ca.certprofile.xijson.conf.ExtensionValueConf.PrivateKeyUsagePeriod;
...
public class V1ExtensionType {
  ...
  public void setSubjectKeyIdentifier(V1SubjectKeyIdentifierControl subjectKeyIdentifier) {
  ...
  public void setCertificatePolicies(V1CertificatePolicies certificatePolicies) {
  ...
  public ExtensionType toV2(Collection<KeySpec> keySpecs) {
    ExtensionType v2 = new ExtensionType(ExtensionID.ofOid(type.oid()), critical, required);
    ...
    if (inRequest != null) {
      ...
      v2.setInRequest(permittedInRequest ? TripleState.optional : TripleState.forbidden);
    }
  ...
  public static V1ExtensionType parse(JsonMap json) throws CodecException {
    ...
    if (required) {
      String[] unsupportedFields = {"additionalInformation", "admissionSyntax", "custom",
          "restriction", "subjectDirectoryAttributs", "validityModel"};
