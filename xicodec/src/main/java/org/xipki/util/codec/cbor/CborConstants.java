...
public interface CborConstants {
  ...
  /** The CBOR-encoded boolean <code>false</code> value (encoded as "simple value": {@link #TYPE_FLOAT_SIMPLE}). */
  int FALSE = 0x14;
  /** The CBOR-encoded boolean <code>true</code> value (encoded as "simple value": {@link #TYPE_FLOAT_SIMPLE}). */
  int TRUE = 0x15;
  /** The CBOR-encoded <code>null</code> value (encoded as "simple value": {@link #TYPE_FLOAT_SIMPLE}). */
  int NULL = 0x16;
  /** The CBOR-encoded "undefined" value (encoded as "simple value": {@link #TYPE_FLOAT_SIMPLE}). */
  int UNDEFINED = 0x17;
  /** Denotes a half-precision float (two-byte IEEE 754, see {@link #TYPE_FLOAT_SIMPLE}). */
  int HALF_PRECISION_FLOAT = TWO_BYTES;
  /** Denotes a single-precision float (four-byte IEEE 754, see {@link #TYPE_FLOAT_SIMPLE}). */
  int SINGLE_PRECISION_FLOAT = FOUR_BYTES;
  /** Denotes a double-precision float (eight-byte IEEE 754, see {@link #TYPE_FLOAT_SIMPLE}). */
