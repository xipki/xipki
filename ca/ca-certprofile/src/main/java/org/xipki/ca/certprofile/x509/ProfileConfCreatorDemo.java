...
import org.xipki.ca.certprofile.x509.jaxb.AddTextType;
...
import org.xipki.ca.certprofile.x509.jaxb.ConditionType;
import org.xipki.ca.certprofile.x509.jaxb.ConstantExtensionType;
import org.xipki.ca.certprofile.x509.jaxb.DSAParametersType;
import org.xipki.ca.certprofile.x509.jaxb.ECParametersType;
import org.xipki.ca.certprofile.x509.jaxb.ECParametersType.Curves;
import org.xipki.ca.certprofile.x509.jaxb.ECParametersType.PointEncodings;
import org.xipki.ca.certprofile.x509.jaxb.EnvParamType;
...
import org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.AuthorityKeyIdentifier;
import org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.CertificatePolicies;
...
import org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.ExtendedKeyUsage.Usage;
import org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.InhibitAnyPolicy;
import org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.KeyUsage;
import org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.NameConstraints;
import org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.PolicyConstraints;
import org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.PolicyMappings;
...
import org.xipki.ca.certprofile.x509.jaxb.KeyUsageType;
...
import org.xipki.ca.certprofile.x509.jaxb.OperatorType;
import org.xipki.ca.certprofile.x509.jaxb.PolicyIdMappingType;
import org.xipki.ca.certprofile.x509.jaxb.RSAParametersType;
...
import org.xipki.ca.certprofile.x509.jaxb.SubjectInfoAccessType;
...
public class ProfileConfCreatorDemo
{
    ...
    throws Exception
    {
        ...
        rdnControls.add(createRDN(ObjectIdentifiers.DN_C, 1, 1, new String[]{"DE|FR"}));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_O, 1, 1, null));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_OU, 0, 1, null));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_SN, 0, 1, new String[]{REGEX_SN}));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_CN, 1, 1, null));
    ...
    throws Exception
    {
        ...
        rdnControls.add(createRDN(ObjectIdentifiers.DN_OU, 0, 1, null));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_SN, 0, 1, new String[]{REGEX_SN}));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_CN, 1, 1, new String[]{REGEX_FQDN}));
    ...
    throws Exception
    {
        ...
        List<RdnType> rdnControls = subject.getRdn();
        rdnControls.add(createRDN(ObjectIdentifiers.DN_C, 1, 1, new String[]{"DE"}));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_O, 1, 1, null));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_OU, 0, 1, null));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_ST, 0, 1, null));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_L, 0, 1, null));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_POSTAL_CODE, 0, 1, null));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_STREET, 0, 1, null));
        // regex: ICCSN-yyyyMMdd
        String regex = "80276[\\d]{15,15}-20\\d\\d(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])";
        rdnControls.add(createRDN(ObjectIdentifiers.DN_CN, 1, 1, new String[]{regex}));
    ...
    throws Exception
    {
        ...
        rdnControls.add(createRDN(ObjectIdentifiers.DN_OU, 2, 2, new String[]{regex_ou1,regex_ou2}));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_SN, 0, 1, new String[]{REGEX_SN}));
        rdnControls.add(createRDN(ObjectIdentifiers.DN_CN, 1, 1, null));
    ...
    private static org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.KeyUsage createRequiredKeyUsages(
            KeyUsageEnum... keyUsages)
    {
        org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.KeyUsage ret =
                new org.xipki.ca.certprofile.x509.jaxb.ExtensionsType.KeyUsage();
