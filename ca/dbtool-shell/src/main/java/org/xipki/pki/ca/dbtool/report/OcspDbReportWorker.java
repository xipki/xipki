...
public class OcspDbReportWorker extends DbPortWorker
{
    private static final Logger LOG = LoggerFactory.getLogger(OcspDbReportWorker.class);
    private final DataSourceWrapper dataSource;
    private final String destFolder;
    private final int numCertsPerSelect;

    public OcspDbReportWorker(
    ...
    throws Exception
    {
        ...
        try
        {
            OcspDbReporter reporter = new OcspDbReporter(dataSource, destFolder, stopMe, numCertsPerSelect);
            reporter.report();
        } finally
        {
            try
