...
if [ "$dataSourceClassName" != "" ]; then
    ...
    elif [ "$dataSourceClassName" = "org.postgresql.ds.PGSimpleDataSource" ]; then
       DRIVER="org.postgresql.Driver"
       URL="jdbc:postgresql://$dataSource_serverName:$dataSource_portNumber/$dataSource_databaseName"
