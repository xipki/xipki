...
public class CaRequestCertsReader extends DbiXmlReader {

    public CaRequestCertsReader(final InputStream xmlStream)
    throws XMLStreamException, InvalidDataObjectException {
        super("reqcerts", xmlStream);
    }

    @Override
    protected DbDataObject retrieveNext() throws InvalidDataObjectException, XMLStreamException {
        CaRequestCertType ret = null;
        ...
        while (reader.hasNext()) {
            ...
            case XMLStreamConstants.START_ELEMENT:
                if (CaRequestCertType.TAG_ROOT.equals(reader.getLocalName())) {
                    ret = new CaRequestCertType();
                }
                break;
            ...
            case XMLStreamConstants.END_ELEMENT:
                ...
                case CaRequestCertType.TAG_ROOT:
                    ret.validate();
                    return ret;
