...
{	
	...
	void addCA(CAEntry newCaDbEntry) throws CAMgmtException;
	...
	void addCmpRequestor(CmpRequestorEntry dbEntry) throws CAMgmtException;
	
	void removeCmpRequestor(String requestorName) throws CAMgmtException;

	void changeCmpRequestor(String name, String cert) throws CAMgmtException;
	
	void removeCmpRequestorFromCA(String requestorName, String caName) throws CAMgmtException;

	void addCmpRequestorToCA(CAHasRequestorEntry requestor, String caName) throws CAMgmtException;
	...
	void setCmpResponder(CmpResponderEntry dbEntry) throws CAMgmtException;

	void removeCmpResponder() throws CAMgmtException;
	
	void changeCmpResponder(String type, String conf, String cert) throws CAMgmtException;
	...
	void changeCrlSigner(String name, String signer_type, String signer_conf, String signer_cert, 
			Integer period, Integer overlap, Boolean includeCerts) throws CAMgmtException;
	
	CrlSignerEntry getCrlSigner(String name);

	void setCrlSignerInCA(String crlSignerName, String caName) throws CAMgmtException;
	...
	void setCmpControl(CmpControl dbEntry) throws CAMgmtException;
	
	void removeCmpControl() throws CAMgmtException;

	void changeCmpControl(Boolean requireConfirmCert, Integer messageTimeBias,
			Integer confirmWaitTime, Boolean sendCaCert) throws CAMgmtException;
