...
public class CaManagerImpl implements CaManager, CmpResponderManager, ScepManager {
        ...
        public void run() {
            ...
            try {
                try {
                    ...
                    final String msg = "could not call certstore.deleteCertsInProcessOlderThan";
    ...
    private boolean startCa(
        ...
        if (signerRequired && masterMode && crlSignerName != null) {
            ...
            } catch (SecurityException | OperationException | InvalidConfException ex) {
                String message = "X09CrlSignerEntryWrapper.initSigner (name=" + crlSignerName + ")";
                LOG.error(LogUtil.getErrorLog(message), ex.getClass().getName(), ex.getMessage());
                LOG.debug(message, ex);
                return false;
            }
    ...
    public void shutdown() {
        ...
        for (String dsName :datasources.keySet()) {
            ...
            try {
                ...
                final String msg = "could not shutdown datasource " + dsName;
                if (LOG.isWarnEnabled()) {
    ...
    throws CaMgmtException {
        ...
        try {
            result = X509SelfSignedCertBuilder.generateSelfSigned(securityFactory,
                    signerType, caEntry.getSignerConf(),
    ...
    throws SecurityException {
        ...
        if (list == null) {
            throw new SecurityException("no algo is defined in CA signerConf");
        }
