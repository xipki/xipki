...
@Command(scope = "caclient", name = "ra-gencrl", description="Generate CRL")
public class RAGenCRLCommand extends ClientCommand {
    ...
    protected Object doExecute() throws Exception {
        ...
        X509CRL crl = raWorker.generateCRL(caName);
        if(crl == null)
        {
