...
@Command(scope = "xipki-ca", name = "publisher-export", description="export publisher configuration")
public class PublisherExportCommand extends CaCommand
{
    ...
    throws Exception
    {
        ...
        {
            saveVerbose("saved publisher configuration to", new File(confFile), entry.getConf().getBytes("UTF-8"));
        }
        return null;
    }
}
