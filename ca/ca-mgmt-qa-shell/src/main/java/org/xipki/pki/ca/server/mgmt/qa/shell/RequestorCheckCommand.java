...
import org.xipki.pki.ca.server.mgmt.shell.RequestorUpdateCommand;
...
@Command(scope = "xipki-caqa", name = "requestor-check", description="check information of requestors (QA)")
public class RequestorCheckCommand extends RequestorUpdateCommand
{
