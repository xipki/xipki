...
import org.xipki.pki.ca.server.mgmt.shell.CaCommand;
...
@Command(scope = "xipki-caqa", name = "caalias-check", description="check CA aliases (QA)")
public class CaAliasCheckCommand extends CaCommand
{
    @Option(name = "--ca",
            required = true,
            description = "CA name\n"
