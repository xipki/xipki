...
@Command(scope = "scep", name = "renewal-req", description="enroll certificate via messageType RenewalReq")
public class RenewalReqCommand extends AbstractEnrollCertCommand
{
