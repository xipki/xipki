...
public class MLKEMPublicKey implements PublicKey {
  ...
  private final org.bouncycastle.pqc.jcajce.interfaces.MLKEMPublicKey bc;

  private final MLKEMParameterSpec parameterSpec;

  public MLKEMPublicKey(org.bouncycastle.pqc.jcajce.interfaces.MLKEMPublicKey bc) {
  ...
  org.bouncycastle.pqc.jcajce.interfaces.MLKEMPublicKey getBc() {
    return bc;
  }
}
