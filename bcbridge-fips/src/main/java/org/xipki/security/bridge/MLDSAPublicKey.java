...
public class MLDSAPublicKey implements PublicKey {
  ...
  private final org.bouncycastle.pqc.jcajce.interfaces.MLDSAPublicKey bc;

  private final MLDSAParameterSpec parameterSpec;

  public MLDSAPublicKey(org.bouncycastle.pqc.jcajce.interfaces.MLDSAPublicKey bc) {
  ...
  org.bouncycastle.pqc.jcajce.interfaces.MLDSAPublicKey getBc() {
    return bc;
  }
