...
import org.xipki.security.speed.shell.completer.RSASigAlgCompleter;
...
@Service
// CHECKSTYLE:SKIP
public class BSpeedP11RSASignAction extends BSpeedP11Action {
  ...
  protected BenchmarkExecutor nextTester() throws Exception {
    ...
    return new P11RSASignSpeed(securityFactory, getSlot(), getKeyId(), sigAlgo, getNumThreads(),
