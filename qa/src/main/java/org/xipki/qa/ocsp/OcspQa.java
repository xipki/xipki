...
public class OcspQa {
  ...
  public ValidationResult checkOcsp(
      ...
      OcspResponseOption responseOption, Instant exptectedRevTime, boolean noSigVerify) {
  ...
  public ValidationResult checkOcsp(
    ...
    boolean extendedRevoke = basicResp.getExtension(OIDs.Extn.id_pkix_ocsp_extendedRevoke) != null;
