...
public class GetCaHasUsersForUserResponse extends CommResponse {

  private Map<String, CaHasUserEntry> result;

  public GetCaHasUsersForUserResponse() {
  }

  public GetCaHasUsersForUserResponse(Map<String, CaHasUserEntry> result) {
    this.result = result;
  }
