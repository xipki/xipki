...
public class GetRequestorsForCaResponse extends CommResponse {

  private Set<CaHasRequestorEntry> result;

  public GetRequestorsForCaResponse() {
  }

  public GetRequestorsForCaResponse(Set<CaHasRequestorEntry> result) {
    this.result = result;
  }
