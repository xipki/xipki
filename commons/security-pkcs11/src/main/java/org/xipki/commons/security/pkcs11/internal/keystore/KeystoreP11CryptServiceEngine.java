...
public class KeystoreP11CryptServiceEngine extends P11CryptServiceEngine {

    private static final Logger LOG = LoggerFactory.getLogger(KeystoreP11CryptServiceEngine.class);

    private final Map<String, KeystoreP11Module> modules = new HashMap<>();

    public KeystoreP11CryptServiceEngine(
