...
public class IaikP11CryptServiceEngine extends P11CryptServiceEngine {

    private static final Logger LOG = LoggerFactory.getLogger(IaikP11CryptServiceEngine.class);

    private final Map<String, IaikP11Module> modules = new HashMap<>();

    public IaikP11CryptServiceEngine(
