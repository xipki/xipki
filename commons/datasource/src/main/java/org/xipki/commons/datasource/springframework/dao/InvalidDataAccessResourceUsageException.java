...
package org.xipki.commons.datasource.springframework.dao;
...
public class InvalidDataAccessResourceUsageException extends NonTransientDataAccessException {
     ...
     */
    public InvalidDataAccessResourceUsageException(final String msg) {
        super(msg);
    }
     ...
     */
    public InvalidDataAccessResourceUsageException(final String msg, final Throwable cause) {
        super(msg, cause);
    }
