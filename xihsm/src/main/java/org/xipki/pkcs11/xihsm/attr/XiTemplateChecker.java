...
public class XiTemplateChecker {
  ...
  private static final long[] storage_RO_Attrs = {CKA_CLASS, CKA_TOKEN};
  ...
  private static final long[] data_RW_Attrs =
      HsmUtil.concatenate(storage_RW_Attrs, CKA_APPLICATION, CKA_VALUE, CKA_OBJECT_ID);

  private static final long[] cert_RO_Attrs =
      HsmUtil.concatenate(storage_RO_Attrs, CKA_CERTIFICATE_TYPE, CKA_CERTIFICATE_CATEGORY);

  private static final long[] cert_RW_Attrs =
      HsmUtil.concatenate(storage_RW_Attrs,
          CKA_TRUSTED, CKA_CHECK_VALUE, CKA_PUBLIC_KEY_INFO, CKA_START_DATE, CKA_END_DATE);
  ...
  private static final long[] key_RO_Attrs =
      HsmUtil.concatenate(storage_RO_Attrs, CKA_KEY_TYPE, CKA_KEY_GEN_MECHANISM);

  private static final long[] key_RW_Attrs =
      HsmUtil.concatenate(storage_RW_Attrs,
          CKA_ID, CKA_START_DATE, CKA_END_DATE, CKA_DERIVE, CKA_LOCAL, CKA_ALLOWED_MECHANISMS);
  ...
  private static final long[] publicKey_RW_Attrs = HsmUtil.concatenate(
      key_RW_Attrs, CKA_SUBJECT, CKA_ENCRYPT, CKA_VERIFY, CKA_VERIFY_RECOVER, CKA_WRAP,
  ...
  private static final long[] secretKey_RO_Attrs =
      HsmUtil.concatenate(privateOrSecretKey_RO_Attrs, CKA_VALUE, CKA_VALUE_LEN);

  private static final long[] secretKey_RW_Attrs =
      HsmUtil.concatenate(privateOrSecretKey_RW_Attrs,
          CKA_ENCRYPT, CKA_VERIFY, CKA_WRAP, CKA_TRUSTED, CKA_WRAP_TEMPLATE, CKA_CHECK_VALUE);

  // EC key
  private static final long[] ecPrivateKey_RO_Attrs =
      HsmUtil.concatenate(privateKey_RO_Attrs, CKA_EC_PARAMS, CKA_EC_POINT, CKA_VALUE);

  private static final long[] ecPublicKey_RO_Attrs =
      HsmUtil.concatenate(publicKey_RO_Attrs, CKA_EC_PARAMS, CKA_EC_POINT);
  ...
  private static final long[] rsaPublicKey_RO_Attrs =
      HsmUtil.concatenate(publicKey_RO_Attrs, CKA_MODULUS, CKA_PUBLIC_EXPONENT);
  ...
  public static void assertSecretKeyAttributesSettable(XiTemplate attrs)
      throws HsmException {
    assertSecretKeyAttributesSettable(attrs, secretKey_RO_Attrs, secretKey_RW_Attrs);
  }

  public static void assertRsaPrivateKeyAttributesSettable(XiTemplate attrs)
      throws HsmException {
    assertSecretKeyAttributesSettable(attrs, rsaPrivateKey_RO_Attrs, privateKey_RW_Attrs);
  }

  public static void assertRsaPublicKeyAttributesSettable(XiTemplate attrs)
      throws HsmException {
    assertSecretKeyAttributesSettable(attrs, rsaPublicKey_RO_Attrs, publicKey_RW_Attrs);
  }

  public static void assertEcPrivateKeyAttributesSettable(XiTemplate attrs)
      throws HsmException {
    assertSecretKeyAttributesSettable(attrs, ecPrivateKey_RO_Attrs, privateKey_RW_Attrs);
  }

  public static void assertEcPublicKeyAttributesSettable(XiTemplate attrs) throws HsmException {
    assertSecretKeyAttributesSettable(attrs, ecPublicKey_RO_Attrs, publicKey_RW_Attrs);
  }

  public static void assertMldsaPrivateKeyAttributesSettable(XiTemplate attrs)
      throws HsmException {
    assertSecretKeyAttributesSettable(attrs, mldsaPrivateKey_RO_Attrs, privateKey_RW_Attrs);
  }

  public static void assertMldsaPublicKeyAttributesSettable(XiTemplate attrs)
      throws HsmException {
    assertSecretKeyAttributesSettable(attrs, mldsaPublicKey_RO_Attrs, publicKey_RW_Attrs);
  }

  public static void assertMlkemPrivateKeyAttributesSettable(XiTemplate attrs)
      throws HsmException {
    assertSecretKeyAttributesSettable(attrs, mlkemPrivateKey_RO_Attrs, privateKey_RW_Attrs);
  }

  public static void assertMlkemPublicKeyAttributesSettable(XiTemplate attrs) throws HsmException {
    assertSecretKeyAttributesSettable(attrs, mlkemPublicKey_RO_Attrs, publicKey_RW_Attrs);
  }

  public static void assertDataAttributesSettable(XiTemplate attrs) throws HsmException {
    assertSecretKeyAttributesSettable(attrs, data_RO_Attrs, data_RW_Attrs);
  }

  public static void assertX509CertAttributesSettable(XiTemplate attrs) throws HsmException {
    assertSecretKeyAttributesSettable(attrs, x509Cert_RO_Attrs, x509Cert_RW_Attrs);
  }

  private static void assertSecretKeyAttributesSettable(
      XiTemplate attrs, long[] roTypes, long[] rwTypes) throws HsmException {
    for (long type : attrs.getTypes()) {
      if (HsmUtil.contains(roTypes, type)) {
        throw new HsmException(CKR_ATTRIBUTE_READ_ONLY,
            "Attribute " + PKCS11T.ckaCodeToName(type) + " is read-only");
      }

      if (!HsmUtil.contains(rwTypes, type)) {
        throw new HsmException(CKR_ATTRIBUTE_TYPE_INVALID,
            "Attribute " + PKCS11T.ckaCodeToName(type) + " is not allowed");
      }
    }
  }
