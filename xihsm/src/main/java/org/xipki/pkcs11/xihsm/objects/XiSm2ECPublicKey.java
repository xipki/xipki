...
public class XiSm2ECPublicKey extends XiWeierstrassECPublicKey {
  ...
  public XiSm2ECPublicKey(
      ...
      Long keyGenMechanism, byte[] ecParams, byte[] ecPoint) throws HsmException {
    ...
    if (curve != WeierstraussCurveEnum.SM2) {
      throw new IllegalArgumentException("ecParams is not for the curve SM2P256V1");
    }
  }
  ...
  public static XiSm2ECPublicKey newInstance(
      ...
      boolean inToken, XiTemplate attrs, long keyType, Long keyGenMechanism)
      throws HsmException {
