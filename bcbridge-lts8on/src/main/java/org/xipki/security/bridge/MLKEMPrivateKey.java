...
public class MLKEMPrivateKey implements PrivateKey {
  ...
  private final org.bouncycastle.jcajce.interfaces.MLKEMPrivateKey bc;

  private final MLKEMParameterSpec parameterSpec;

  public MLKEMPrivateKey(org.bouncycastle.jcajce.interfaces.MLKEMPrivateKey bc) {
  ...
  org.bouncycastle.jcajce.interfaces.MLKEMPrivateKey getBc() {
    return bc;
  }
}
