...
public class MLKEMParameterSpec {
  ...
  private final org.bouncycastle.jcajce.spec.MLKEMParameterSpec bc;

  private MLKEMParameterSpec(org.bouncycastle.jcajce.spec.MLKEMParameterSpec bc) {
  ...
  org.bouncycastle.jcajce.spec.MLKEMParameterSpec getBc() {
    return bc;
  }

  static MLKEMParameterSpec of(org.bouncycastle.jcajce.spec.MLKEMParameterSpec bc) {
    switch (bc.getName().toUpperCase(Locale.ROOT).replace("-", "")
        .replace("_", "")) {
      case "MLKEM512":
        return ml_kem_512;
      case "MLKEM768":
