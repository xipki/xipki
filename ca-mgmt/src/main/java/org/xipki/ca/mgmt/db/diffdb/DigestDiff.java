  ...
  public DigestDiff(
    ...
    if (this.numTargetThreads != numThreads) {
      LOG.info("reduce the numTargetThreads from {} to {}",
          numTargetThreads, this.numTargetThreads);
    }
  } // constructor
  ...
  private void diffSingleCa(RefDigestReader refReader,
    ...
    try {
      ...
      target = new TargetDigestReader(revokedOnly, processLog, refReader,
          reporter, targetDatasource, targetDbType, certhashAlgo, caId,
          numPerSelect, numTargetThreads, stopMe);
      ...
      reporter.addError("Exception thrown: " +
