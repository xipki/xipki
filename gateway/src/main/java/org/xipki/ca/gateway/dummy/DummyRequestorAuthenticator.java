...
public class DummyRequestorAuthenticator implements RequestorAuthenticator {
  ...
  static {
    System.err.println("DO NOT USE "
        + DummyRequestorAuthenticator.class.getName()
  ...
  private static class DummyPasswordRequestor
      implements Requestor.PasswordRequestor {
  ...
  private static class DummySimpleasswordRequestor
      implements Requestor.SimplePasswordRequestor {
