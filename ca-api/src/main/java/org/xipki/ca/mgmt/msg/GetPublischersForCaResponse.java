...
public class GetPublischersForCaResponse extends CommResponse {

  private List<PublisherEntry> result;

  public GetPublischersForCaResponse() {
  }

  public GetPublischersForCaResponse(List<PublisherEntry> result) {
    this.result = result;
  }
