...
public interface CaManager {
  ...
  /**
   * Although it is possible to configure it to 1, it is recommended to set it
   * to at least 9. At least 64 bit entropy is required. Since the highest bit
   * is set to 0, at least 9 bytes is recommended.
   */
  ...
  /**
   * Republishes certificates of the CA {@code caName} to the publishers
   * {@code publisherNames}.
   *
   * @param caName
  ...
  /**
   * Removes the support of the certprofile {@code profileName} from the CA
   * {@code caName}.
   *
   * @param profileName
   ...
   *          if error occurs.
   */
  void addCertprofileToCa(String profileNameAliases, String caName)
      throws CaMgmtException;
   ...
   */
  Set<CaProfileEntry> getCertprofilesForCa(String caName)
      throws CaMgmtException;
  ...
  /**
   * Changes the requestor {@code name} of type CERTIFICATE.
   * @param name
   *        name of the certificate profile to be changed. Must not be
   *        {@code null}.
   * @param type
   ...
   * @param name
   *        name of the keypair generation entry to be changed. Must not be
   *        {@code null}.
   * @param type
   *        Type to be changed. {@code null} indicates no change.
   * @param conf
   ...
   *        Configuration to be changed. {@code null} indicates no change.
   * @param base64Cert
   *        Base64 encoded certificate of the signer. {@code null} indicates no
   *        change.
   * @throws CaMgmtException
   *          if error occurs.
   */
   ...
   *          if error occurs.
   */
  void revokeCertificate(String caName, BigInteger serialNumber,
  ...
  /**
   * Returns CA certificate chain, starting with the CA's certificate, for the
   * CA {@code caName}.
   * @param caName
   *        CA name. Must not be {@code null}.
   ...
   *        Byte array of the zipped Configuration the CA system. Must not be
   *        {@code null}.
   * @throws IOException
   ...
   *        Inputstream of the zipped Configuration the CA system. Must not be
   *        {@code null}.
   * @throws IOException
   *         If read the ZIP stream fails.
   * @throws CaMgmtException
   *         if other error occurs.
   */
  void loadConfAndClose(InputStream zippedConfStream)
      throws CaMgmtException, IOException;

  /**
   * Exports the CA system configuration to a zip-stream.
   * @param caNames
   *        List of the names of CAs to be exported. {@code null} to export
   *        all CAs.
