...
public class DomainValidator {
  ...
  static class RegexValidator {
     ...
     * @param caseSensitive when <code>true</code> matching is
     * <i>case-sensitive</i>, otherwise matching is <i>case in-sensitive</i>
     */
  ...
  // Regular expression strings for hostnames (derived from RFC2396 and
  // RFC 1123)
  ...
  private final RegexValidator domainRegex =
      new RegexValidator(DOMAIN_NAME_REGEX, true);
  ...
  public boolean isValid(String domain) {
    String[] groups = domainRegex.match(domain.startsWith("*.")
