...
class CrlSignerEntryWrapper {

  private CrlSignerEntry dbEntry;
  ...
  CrlSignerEntryWrapper() {
  }

  public void setDbEntry(CrlSignerEntry dbEntry) throws InvalidConfException {
  ...
  public CrlSignerEntry getDbEntry() {
    return dbEntry;
  }
