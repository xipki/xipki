...
public class DummyMainEC {
  ...
  private static void ff() throws Exception {
    ...
    /*
    RSAPrivateCrtKey priv = (RSAPrivateCrtKey) requestor.getPrivate();
    PrivateKeyInfo transportPrivKey = new PrivateKeyInfo(
    ...
    */
    ...
    ECPrivateKey priv = (ECPrivateKey) requestor.getPrivate();
    int orderBitLength = priv.getParams().getOrder().bitLength();
    PrivateKeyInfo transportPrivKey = new PrivateKeyInfo(algId,
