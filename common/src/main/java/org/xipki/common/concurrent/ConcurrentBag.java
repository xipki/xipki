...
import static org.xipki.common.concurrent.ConcurrentBag.IConcurrentBagEntry.STATE_IN_USE;
import static org.xipki.common.concurrent.ConcurrentBag.IConcurrentBagEntry.STATE_NOT_IN_USE;
import static org.xipki.common.concurrent.ConcurrentBag.IConcurrentBagEntry.STATE_REMOVED;
import static org.xipki.common.concurrent.ConcurrentBag.IConcurrentBagEntry.STATE_RESERVED;
...
public class ConcurrentBag<T extends IConcurrentBagEntry> implements AutoCloseable {
    ...
    public boolean remove(final T bagEntry) {
        ...
        if (!removed && !closed) {
            LOGGER.warn("Attempt to remove an object from the bag that does not exist: {}",
                    bagEntry);
        }
