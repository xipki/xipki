...
import org.xipki.util.password.PBEAlgo;
import org.xipki.util.password.PasswordBasedEncryption;
...
public class PBEWithHmacSHA256AndAES256Test {
  ...
  public void encryptThenDecrypt() throws Exception {
    ...
    byte[] encrypted = PasswordBasedEncryption.encrypt(algo,
                        plainText, password, iterationCount, salt);
    byte[] decrypted = PasswordBasedEncryption.decrypt(algo,
                        encrypted, password, iterationCount, salt);
