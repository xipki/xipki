...
----
1. (Optional) If you use database other than MariaDB and MySQL:  
...
2. Adapt the database configurations `*-db.properties` in the folder `tomcat/xipki/etc/ca/database`.
3. Create new databases configured in Step 3.
