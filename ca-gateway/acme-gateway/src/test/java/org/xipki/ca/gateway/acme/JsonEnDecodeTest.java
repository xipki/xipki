...
public class JsonEnDecodeTest {
  ...
  public void decodeTimestamp() {
    Instant t1 = Instant.parse("2016-01-01T05:04:01+04:00");
    Instant t2 = Instant.parse("2016-01-01T01:04:01Z");
    Assert.assertEquals("timestamp", t1, t2);
    System.out.println(t1);

    Instant t3 = Instant.parse("2016-01-01T05:04:01.99+04:00");
    Instant t4 = Instant.parse("2016-01-01T01:04:01.99Z");
    Assert.assertEquals("timestamp", t1, t2);
