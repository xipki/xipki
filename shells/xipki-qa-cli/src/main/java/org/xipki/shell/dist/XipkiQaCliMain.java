...
import org.xipki.shell.qa.QaShellMain;
...
public class XipkiQaCliMain {
  ...
  public static void main(String[] args) throws Exception {
    ...
    addModuleSubcommands(commandLine, new QaShellMain.RootCommand());
  ...
  @Command(name = "xipki-qa-cli", description = "XiPKI QA CLI",
