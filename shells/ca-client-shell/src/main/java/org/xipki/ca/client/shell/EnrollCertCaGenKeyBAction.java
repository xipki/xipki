...
@Service
public class EnrollCertCaGenKeyBAction extends ClientAction {
  ...
  @Option(name = "--key-out", required = true,
      description = "where to save the private key")
  @Completion(FileCompleter.class)
  private String keyOutputFile;
  ...
  protected Object execute0() throws Exception {
    ...
    EnrollCertRequestEntry reqEntry = new EnrollCertRequestEntry("id-1", profile, certReq, keytype);
    ...
    if (result != null) {
      ...
      privateKey = certOrError.getPrivateKeyInfo();
    }
    ...
    File keyFile = new File(keyOutputFile);
    saveVerbose("saved key to file", keyFile, privateKey.getEncoded());
