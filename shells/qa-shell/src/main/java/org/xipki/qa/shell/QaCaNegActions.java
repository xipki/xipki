...
public class QaCaNegActions {
  ...
  @Command(scope = "caqa", name = "neg-caprofile-add", description =
      "add certificate profiles to CA (negative, QA)")
  @Service
  public static class NegCaprofileAdd extends ProfileActions.CaprofileAdd {
  ...
  @Command(scope = "caqa", name = "neg-caprofile-rm", description =
      "remove certificate profile from CA (negative, QA)")
  @Service
  public static class NegCaprofileRm extends ProfileActions.CaprofileRm {
  ...
  @Command(scope = "caqa", name = "neg-capub-add", description =
      "add publishers to CA (negative, QA)")
  @Service
  public static class NegCaPubAdd extends PublisherActions.CapubAdd {
  ...
  @Command(scope = "caqa", name = "neg-capub-rm", description =
      "remove publisher from CA (negative, QA)")
  @Service
  public static class NegCapubRm extends PublisherActions.CapubRm {
  ...
  @Command(scope = "caqa", name = "neg-careq-add", description =
      "add requestor to CA (negative, QA)")
  @Service
  public static class NegCaReqAdd extends RequestorActions.CareqAdd {
  ...
  @Command(scope = "caqa", name = "neg-careq-rm", description =
      "remove requestor in CA (negative, QA)")
  @Service
  public static class NegCareqRm extends RequestorActions.CareqRm {
  ...
  @Command(scope = "caqa", name = "neg-enroll-cert", description =
      "enroll certificate (negative, QA)")
  @Service
  ...
  @Command(scope = "caqa", name = "neg-gen-rootca", description =
  ...
  @Command(scope = "caqa", name = "neg-profile-add", description =
      "add certificate profile (negative, QA)")
  @Service
  public static class NegProfileAdd extends ProfileActions.ProfileAdd {
  ...
  @Command(scope = "caqa", name = "neg-profile-up", description =
      "update certificate profile (negative, QA)")
  @Service
  public static class NegProfileUp extends ProfileActions.ProfileUp {
  ...
  @Command(scope = "caqa", name = "neg-publisher-rm", description =
      "remove publisher (negative, QA)")
  @Service
  public static class NegPublisherRm extends PublisherActions.PublisherRm {
  ...
  @Command(scope = "caqa", name = "neg-publisher-up", description =
      "update publisher (negative, QA)")
  @Service
  public static class NegPublisherUp extends PublisherActions.PublisherUp {
  ...
  @Command(scope = "caqa", name = "neg-republish", description =
      "republish certificates (negative, QA)")
  @Service
  public static class NegRepublish extends MiscActions.Republish {
  ...
  @Command(scope = "caqa", name = "neg-requestor-rm", description =
      "remove requestor (negative, QA)")
  @Service
  public static class NegRequestorRm extends RequestorActions.RequestorRm {
  ...
  @Command(scope = "caqa", name = "neg-requestor-up", description =
      "update requestor (negative, QA)")
  @Service
  public static class NegRequestorUp extends RequestorActions.RequestorUp {
  ...
  @Command(scope = "caqa", name = "neg-revoke-cert", description =
      "revoke certificate (negative, QA)")
  @Service
  ...
  @Command(scope = "caqa", name = "neg-unrevoke-cert", description =
      "unrevoke certificate (negative, QA)")
  @Service
